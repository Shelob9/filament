...
@php
    $buttonClasses = array_merge([
        ...
        'text-primary-500 border-primary-500 hover:bg-primary-500/20 focus:bg-primary-700/20 focus:ring-offset-primary-700' => $color === 'primary',
        ...
        'text-gray-800 border-gray-300 hover:bg-gray-50 focus:ring-primary-500 focus:text-primary-500 focus:bg-primary-50 focus:border-primary-500' => $color === 'secondary',
        'dark:text-primary-500 dark:border-primary-500 dark:hover:bg-primary-500/20 dark:focus:bg-primary-500/20 dark:focus:ring-offset-primary-500' => $color === 'primary' && $darkMode,
        ...
        'bg-primary-500 hover:bg-primary-500 focus:bg-primary-700 focus:ring-offset-primary-700' => $color === 'primary',
        ...
        'text-gray-800 bg-white border-gray-300 hover:bg-gray-50 focus:ring-primary-500 focus:text-primary-500 focus:bg-primary-50 focus:border-primary-500' => $color === 'secondary',
